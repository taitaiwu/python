...
## 檔案內容
1. Playfair Cipher 加解密系統實作：[1.Playfair_Cipher](1.Playfair_Cipher)
2. DES 對稱加密系統實作 (Simplified/Full)：[2.DES](2.DES)
3. AES 加密系統的雪崩效應量化分析：[3.AES_Avalanche_Effect](3.AES_Avalanche_Effect)
4. BBS 亂數產生器實作：[4.Blum_Blum_Shub_Random_Generator](4.Blum_Blum_Shub_Random_Generator)